...
public class GitSetupCommandTest
{
   ...
   public void setup() throws Exception
   {
      ...
      commandController = testHarness.createCommandController(GitSetupCommand.class, project.getProjectRoot());
   ...
   public void testGitSetup() throws Exception
   {
      ...
      assertTrue(project.getProjectRoot().getChildDirectory(".git").isDirectory());

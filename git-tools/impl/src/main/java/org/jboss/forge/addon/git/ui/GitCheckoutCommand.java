...
public class GitCheckoutCommand extends AbstractGitCommand implements UICommand
{
   ...
   public Result execute(UIExecutionContext context) throws Exception
   {
      ...
      {
         result = Results.fail("This command should be executed in the cotext of a project");
      }
